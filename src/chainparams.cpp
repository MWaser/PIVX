...
static const Checkpoints::CCheckpointData data = {
	&mapCheckpoints,
	1519135358, // * UNIX timestamp of last checkpoint block
...
public:
	CMainParams()
	{
		...
		vAlertPubKey = ParseHex("045e5e617409af55bcd525d6f4aee4e39e60936504e295e6f8973a257dda666e0805c9b8c3ce55d7e8f7e7112543299c11899db82e7f5655592a312f61a29fcf0c");
		nDefaultPort = 51472;
		 ...
		 *   vMerkleTree: e0028e
		 */
		const char* pszTimestamp = "Washington Post Jun 01 2018 Divi Takes Crypt World By Storm";
		CMutableTransaction txNew;
		txNew.vin.resize(1);
		txNew.vout.resize(1);
		txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
		txNew.vout[0].nValue = 250 * COIN;
		txNew.vout[0].scriptPubKey = CScript() << ParseHex("04195342fb01a3cca752f856c25edd7fc342c79635f3c4c4e9e0e3c4f30f5c6bbc90d977f11090dc6c90a68b48a8c540d8523d6facf3c17aa5072f56d0bacc7e65") << OP_CHECKSIG;
		...
		base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 32);  // Mainnet divi addresses start with 'D' or 'E'
		base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 17);  // Mainnet divi script addresses start with '7' or '8'
		base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 217);
		base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x07)(0x2B)(0x4D)(0x33).convert_to_container<std::vector<unsigned char> >();
		base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x07)(0x4D)(0x2B)(0x33).convert_to_container<std::vector<unsigned char> >();
...
public:
	CTestNetParams()
	{
		...
		vAlertPubKey = ParseHex("048f642aa7eb8061038992c83d95deb701eaa0e5ddb8f975bf29752ba889d5586acd1fd6b6d3891b5a09db5c591c1e6abc8ae120b2d77452017c86174b43e9d449");
		nDefaultPort = 51474;
		...
		base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 91);  // Testnet divi addresses start with 'd' or 'e'
		base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 126);  // Testnet divi script addresses start with 's' or 't'
		base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 227);
		base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x11)(0x77)(0x69)(0x96).convert_to_container<std::vector<unsigned char> >();
		base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x11)(0x77)(0x67)(0x76).convert_to_container<std::vector<unsigned char> >();
